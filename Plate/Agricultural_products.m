...
targetList(1).Code='A0000';%725
targetList(2).Market='DCE';
targetList(2).Code='C0000';
targetList(3).Market='DCE';
targetList(3).Code='M0000';
targetList(4).Market='DCE';
targetList(4).Code='P0000';
targetList(5).Market='DCE';
targetList(5).Code='Y0000';
...
set(gca,'xtick',[1 2 3 4 5 6],'xticklabel',{'                            豆一','                                玉米','                               豆粕','                              棕榈油','                              豆油',' '});
title('农产品板块主力合约在共有交易日内的资金流向表（黑色代表流出、白色代表流入）')  ; 
ylabel('第y个交易日');
